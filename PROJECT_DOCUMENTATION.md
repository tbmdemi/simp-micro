...
> **⚠️ TÀI LIỆU LỊCH SỬ, ĐÃ LỖI THỜI ĐÁNG KỂ.** Viết trước khi dự án đổi tên thành AuxForge, đổi sang branch `FixLoss`, và trước toàn bộ khối lượng việc mô tả trong [EXPERIMENT_LOG.md](EXPERIMENT_LOG.md) (dQ-fix, dọn nhãn dao động, differentiable-physics...). Cụ thể các số liệu/checkpoint dưới đây (`surrogate_best.pt`, `cvae_best.pt`, R² Phase 4 = 0,910/0,911/0,982, "Phase 6 chưa triển khai") **không còn đúng** - checkpoint khuyến nghị hiện tại là `outputs/phase5/cvae_realphysics.pt`, xem [README.md](README.md) cho trạng thái/số liệu hiện hành. Giữ lại tài liệu này chỉ vì phần mô tả kiến trúc/thuật toán (mục 0-3) vẫn đúng về mặt kỹ thuật; đọc phần "Kết quả thực tế"/"Output" của mục 4-6 với sự cẩn trọng.

**Repo:** `github.com/tbmdemi/simp-micro`, branch `OnlyAuxetic` (lịch sử - repo/branch hiện tại xem README.md)
