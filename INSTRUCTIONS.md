...
> **⚠️ LỊCH SỬ - kỹ thuật gamma-sweep-qua-surrogate mô tả dưới đây đã bị vượt qua bởi differentiable-physics (2026-07-24).** Sweep gamma chỉ tối ưu qua surrogate đóng băng nên vẫn dính surrogate-exploitation (xem [EXPERIMENT_LOG.md](EXPERIMENT_LOG.md)); checkpoint khuyến nghị hiện tại là `outputs/phase5/cvae_realphysics.pt` (train bằng `real_physics_prior_loss()`, không phải gamma-sweep qua surrogate). Giữ tài liệu này làm tham khảo lịch sử cho quy trình gamma-sweep, không phải hướng dẫn cho công việc mới - xem [README.md](README.md) mục "5. Conditional VAE" cho quy trình hiện hành.
