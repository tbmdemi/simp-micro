function topK_circle_update(nelx, nely, volfrac, penal, rmin, ft, nu, beta, ...
...
% =========================================================================
% PER-PATTERN 2: SEED MASK — topK_circle
% Single centered circle. Native legacy: r = nelx/4. New formula: r = vsf * nelx / 2.
% At vsf = 0.5 -> r = 25 -> diameter 50 -> 50% cell side.
[I, J] = meshgrid(1:nelx, 1:nely);
center_x = nelx / 2; center_y = nely / 2;
r = void_size_frac * nelx / 2;

seed_mask = (sqrt((I - center_x).^2 + (J - center_y).^2) <= r);
% END PER-PATTERN 2
% =========================================================================
