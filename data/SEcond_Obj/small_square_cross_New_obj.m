...
function small_square_cross_New_obj(nelx, nely, volfrac, penal, rmin, ft)
...
inner_square_size = floor(min(nelx, nely) / 15); % Size of the inner squares near the corners
...
while (change > 0.01)
    ...
    if loop < 20 % Control for the first 10 iterations
