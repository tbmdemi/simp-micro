...
Lộ trình thiết kế ngược gồm 8 giai đoạn (phase). Phase 1-4 đã hoàn thành và được xác thực trên dữ liệu thực; Phase 5 (cVAE) đã sửa tận gốc bằng differentiable real-physics, đạt R²(FE,n=789)=0,999/hit-rate 98,7%.

> **Cập nhật 2026-07-31:** roadmap chi tiết Phase 6-8 (hậu xử lý & kiểm định FEA / active-learning loop / xác thực cuối & đóng gói) dùng đánh số KHÁC bảng bên dưới (bảng này dùng quy ước cũ hơn, "Phase 6" ở đây = nâng cấp cGAN/diffusion tuỳ chọn, chưa làm). Trạng thái đầy đủ theo roadmap Phase 6-8 thật: xem [`outputs/phase5/reports/final_status_report_2026-07-31.md`](outputs/phase5/reports/final_status_report_2026-07-31.md) và [EXPERIMENT_LOG.md](EXPERIMENT_LOG.md) mục 2026-07-30/2026-07-31 - tóm tắt: hậu xử lý/kiểm định FEA đã có sẵn, active-learning loop đã implement+chạy thật (kết luận không cải thiện checkpoint đã tối ưu), đối chiếu FE độc lập bằng `scikit-fem` đã xác nhận solver đúng vật lý (R²=1,000000), thư viện 24 thiết kế đã tuyển chọn (87,5% xác nhận manufacturable).
