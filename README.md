...
- **Claim ĐƯỢC ủng hộ bởi bằng chứng:** (1) engine FE/homogenization đúng vật lý, đối chiếu độc lập bằng `scikit-fem` tới sai số làm tròn dấu phẩy động (Giới hạn #15); (2) `cvae_realphysics.pt`/`cvae_v2_finetuned.pt` sinh single-shot đáng tin cậy để dự đoán (v₁₂,v₂₁) đúng DẤU ở tỉ lệ cao (n=789, toàn bộ test set); (3) cVAE sinh ra thiết kế KHÔNG phải sao chép gần training set (novelty, n=480 mẫu sinh - Giới hạn #18).
